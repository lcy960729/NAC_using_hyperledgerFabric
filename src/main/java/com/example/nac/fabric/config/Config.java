...
public class Config {
	...
	public static final String CHAINCODE_ACC_PATH = "github.com/acc";
	public static final String CHAINCODE_ACC_VERSION = "3";

	public static final String CHAINCODE_RC_NAME = "rc";
	public static final String CHAINCODE_RC_PATH = "github.com/rc";
	public static final String CHAINCODE_RC_VERSION = "3";

	public static final String CHAINCODE_JC_NAME = "jc";
	public static final String CHAINCODE_JC_PATH = "github.com/jc";
