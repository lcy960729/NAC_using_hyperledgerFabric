...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"addUser\", function() { return addUser; });\n/* harmony import */ var _updateNetwork__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./updateNetwork */ \"./assets/js/Home/updateNetwork.js\");\n/* harmony import */ var _home__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./home */ \"./assets/js/Home/home.js\");\n\n\nvar addUser = function addUser() {\n  var userData = {\n    subjectId: lookUpTable.id,\n    object: {\n      name: document.getElementById('objectName').value,\n      macAddress: document.getElementById('objectMacAddress').value\n    },\n    resource: document.getElementById('resource').value,\n    action: document.getElementById('action').value,\n    permission: document.getElementById('permission').value,\n    threshold: document.getElementById('threshold').value,\n    minInterval: document.getElementById('minInterval').value\n  };\n  fetch(\"http://\" + server + \":9322/api/v1/policyTables\", {\n    method: 'POST',\n    headers: {\n      'content-Type': 'application/json',\n      'orgAffiliation': 'userOrg',\n      'orgMspId': 'UserOrgMSP'\n    },\n    body: JSON.stringify(userData)\n  }).then(function (res) {\n    if (res.status === 200 || res.status === 201) {\n      var policyId = res.headers.get('Location').split('/')[2];\n      userData.object.policyId = policyId;\n      lookUpTable.objects.push(userData.object);\n      Object(_updateNetwork__WEBPACK_IMPORTED_MODULE_0__[\"updateNetwork\"])();\n      Object(_home__WEBPACK_IMPORTED_MODULE_1__[\"closeAddUserPopup\"])();\n    } else {\n      console.log(res.statusText);\n    }\n  });\n};\n\n//# sourceURL=webpack:///./assets/js/Home/addUser.js?");

/***/ }),

/***/ "./assets/js/Home/createNetwork.js":
/*!*****************************************!*\
  !*** ./assets/js/Home/createNetwork.js ***!
  \*****************************************/
...
/*!********************************!*\
  !*** ./assets/js/Home/home.js ***!
  \********************************/
/*! exports provided: closeCreateNetworkPopup, closeAddUserPopup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* WEBPACK VAR INJECTION */(function(global) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"closeCreateNetworkPopup\", function() { return closeCreateNetworkPopup; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"closeAddUserPopup\", function() { return closeAddUserPopup; });\n/* harmony import */ var _getNetworkList__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getNetworkList */ \"./assets/js/Home/getNetworkList.js\");\n/* harmony import */ var _addUser__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./addUser */ \"./assets/js/Home/addUser.js\");\n/* harmony import */ var _updateUser__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./updateUser */ \"./assets/js/Home/updateUser.js\");\n/* harmony import */ var _createNetwork__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./createNetwork */ \"./assets/js/Home/createNetwork.js\");\n/* harmony import */ var _deleteNetwork__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./deleteNetwork */ \"./assets/js/Home/deleteNetwork.js\");\n/* harmony import */ var _deleteNetwork__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_deleteNetwork__WEBPACK_IMPORTED_MODULE_4__);\n/* harmony import */ var _deleteUser__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./deleteUser */ \"./assets/js/Home/deleteUser.js\");\nfunction _createForOfIteratorHelper(o, allowArrayLike) { var it; if (typeof Symbol === \"undefined\" || o[Symbol.iterator] == null) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === \"number\") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError(\"Invalid attempt to iterate non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = o[Symbol.iterator](); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it[\"return\"] != null) it[\"return\"](); } finally { if (didErr) throw err; } } }; }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\n\n\n\n\n\n\nglobal.server = 'localhost';\nglobal.networkList = new Array();\nglobal.lookUpTable = new Object();\nglobal.policyTable = new Object();\nvar addUserPopUpForm = new Array();\nvar title = document.getElementById('addUser_popup_title');\nvar methodNameAtAddUser = document.getElementById('methodNameAtAddUser');\nvar objectName = document.getElementById('objectName');\nvar objectMacAddress = document.getElementById('objectMacAddress');\nvar resource = document.getElementById('resource');\nvar action = document.getElementById('action');\nvar permission = document.getElementById('permission');\nvar threshold = document.getElementById('threshold');\nvar minInterval = document.getElementById('minInterval');\nvar submitUserBtn = document.getElementById('submitUserBtn');\naddUserPopUpForm.push(title);\naddUserPopUpForm.push(methodNameAtAddUser);\naddUserPopUpForm.push(objectName);\naddUserPopUpForm.push(objectMacAddress);\naddUserPopUpForm.push(resource);\naddUserPopUpForm.push(action);\naddUserPopUpForm.push(permission);\naddUserPopUpForm.push(threshold);\naddUserPopUpForm.push(minInterval);\naddUserPopUpForm.push(submitUserBtn);\nvar createNetwork_popup = document.getElementById('network-popup');\nvar createNetwork_popup_closeBtn = document.getElementById('closeBtn');\nvar createNetwork_popup_openBtn = document.getElementById('addNetworkBtn');\nvar addUser_popup = document.getElementById('addUser-popup');\nvar addUser_popup_closeBtn = document.getElementById('usp-closeBtn');\nvar addUserBtn = document.getElementById('addUserBtn');\nvar updateUserBtn = document.getElementById('updateUserBtn');\nvar closeCreateNetworkPopup = function closeCreateNetworkPopup() {\n  createNetwork_popup.style.visibility = 'hidden';\n};\ncreateNetwork_popup_closeBtn.addEventListener('click', closeCreateNetworkPopup);\n\nvar viewCreateNetworkPopup = function viewCreateNetworkPopup() {\n  document.getElementById('methodName').value = '';\n  document.getElementById('subjectName').value = '';\n  document.getElementById('macAddress').value = '';\n  createNetwork_popup.style.visibility = 'visible';\n};\n\ncreateNetwork_popup_openBtn.addEventListener('click', viewCreateNetworkPopup);\nvar closeAddUserPopup = function closeAddUserPopup() {\n  addUser_popup.style.visibility = 'hidden';\n};\naddUser_popup_closeBtn.addEventListener('click', closeAddUserPopup);\n\nvar viewAddUserPopup = function viewAddUserPopup(mode) {\n  addUser_popup.style.visibility = 'visible';\n\n  var _iterator = _createForOfIteratorHelper(addUserPopUpForm),\n      _step;\n\n  try {\n    for (_iterator.s(); !(_step = _iterator.n()).done;) {\n      var componant = _step.value;\n      componant.innerHTML = '';\n      componant.value = '';\n    }\n  } catch (err) {\n    _iterator.e(err);\n  } finally {\n    _iterator.f();\n  }\n\n  resource.disabled = true;\n  action.disabled = true;\n\n  if (mode == '사용자 추가') {\n    title.innerText = '사용자 추가';\n    methodNameAtAddUser.value = lookUpTable.methodName;\n    objectMacAddress.disabled = false;\n    resource.value = 'Network';\n    action.value = 'connect';\n    submitUserBtn.innerText = 'Add User';\n  } else {\n    title.innerText = '사용자 수정';\n    methodNameAtAddUser.value = lookUpTable.methodName;\n    objectName.value = policyTable.object.name;\n    objectMacAddress.value = policyTable.object.macAddress;\n    objectMacAddress.disabled = true;\n    resource.value = policyTable.resource;\n    action.value = policyTable.action;\n    permission.value = policyTable.permission;\n    threshold.value = policyTable.threshold;\n    minInterval.value = policyTable.minInterval;\n    submitUserBtn.innerText = 'Update User';\n  }\n};\n\naddUserBtn.addEventListener('click', function (event) {\n  viewAddUserPopup(event.target.innerText);\n});\nupdateUserBtn.addEventListener('click', function (event) {\n  viewAddUserPopup(event.target.innerText);\n});\nsubmitUserBtn.addEventListener('click', function (event) {\n  if (event.target.innerText == 'Add User') {\n    Object(_addUser__WEBPACK_IMPORTED_MODULE_1__[\"addUser\"])();\n  } else {\n    Object(_updateUser__WEBPACK_IMPORTED_MODULE_2__[\"updateUser\"])();\n  }\n});\n\nfunction init() {\n  Object(_getNetworkList__WEBPACK_IMPORTED_MODULE_0__[\"getNetworkList\"])();\n}\n\ninit();\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../node_modules/webpack/buildin/global.js */ \"./node_modules/webpack/buildin/global.js\")))\n\n//# sourceURL=webpack:///./assets/js/Home/home.js?");

/***/ }),

/***/ "./assets/js/Home/updateNetwork.js":
/*!*****************************************!*\
  !*** ./assets/js/Home/updateNetwork.js ***!
  \*****************************************/
/*! exports provided: updateNetwork */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"updateNetwork\", function() { return updateNetwork; });\n/* harmony import */ var _getNetwork__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getNetwork */ \"./assets/js/Home/getNetwork.js\");\n\nvar updateNetwork = function updateNetwork() {\n  var updateNetworkData = {\n    methodName: lookUpTable.methodName,\n    subjectName: lookUpTable.subject.name,\n    objects: lookUpTable.objects,\n    scName: lookUpTable.scName,\n    abi: lookUpTable.abi\n  };\n  fetch(\"http://\" + server + \":9322/api/v1/lookUpTables/\" + lookUpTable.id, {\n    method: 'PUT',\n    headers: {\n      'content-Type': 'application/json',\n      'orgAffiliation': 'userOrg',\n      'orgMspId': 'UserOrgMSP'\n    },\n    body: JSON.stringify(updateNetworkData)\n  }).then(function (res) {\n    if (res.status === 200 || res.status === 201) {\n      Object(_getNetwork__WEBPACK_IMPORTED_MODULE_0__[\"setNetwork\"])();\n    } else {\n      console.log(res.statusText);\n    }\n  });\n};\n\n//# sourceURL=webpack:///./assets/js/Home/updateNetwork.js?");

/***/ }),

/***/ "./assets/js/Home/updateUser.js":
/*!**************************************!*\
  !*** ./assets/js/Home/updateUser.js ***!
  \**************************************/
...
/***/ 1:
/*!*****************************************************************!*\
  !*** multi @babel/polyfill/noConflict ./assets/js/Home/home.js ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! @babel/polyfill/noConflict */\"./node_modules/@babel/polyfill/noConflict.js\");\nmodule.exports = __webpack_require__(/*! /Users/lcy/Desktop/Git_Repository/NAC_using_hyperledgerFabric/frontend/assets/js/Home/home.js */\"./assets/js/Home/home.js\");\n\n\n//# sourceURL=webpack:///multi_@babel/polyfill/noConflict_./assets/js/Home/home.js?");
