...
eval("var server = 'localhost';\n\nvar isCreatedChannel = function isCreatedChannel() {\n  fetch(\"http://\" + server + \":9322/api/v1/NACUser/isCreatedChannel\", {}).then(function (res) {\n    if (res.status === 200 || res.status === 201) {\n      res.text().then(function (isCreatedChannelResult) {\n        if (isCreatedChannelResult === 'true') {\n          document.location.href = '/';\n        } else {\n          document.location.href = '/no_channel';\n        }\n      });\n    } else {\n      console.log(res.statusText);\n    }\n  });\n};\n\nvar login = function login() {\n  var loginInfo = {\n    id: document.getElementById('id').value,\n    pw: document.getElementById('pw').value\n  };\n  fetch(\"http://\" + server + \":9322/api/v1/NACUser/login\", {\n    method: 'POST',\n    body: JSON.stringify(loginInfo)\n  }).then(function (res) {\n    if (res.status === 200 || res.status === 201) {\n      res.text().then(function (loginResult) {\n        if (loginResult === 'true') {\n          isCreatedChannel();\n        } else {\n          document.location.href = '/login';\n        }\n      });\n    } else {\n      console.log(res.statusText);\n    }\n  });\n};\n\nvar loginBtn = document.getElementById('loginBtn');\nloginBtn.addEventListener('click', login);\n\n//# sourceURL=webpack:///./assets/js/Login/login.js?");
...
/***/ 0:
/*!*******************************************************************!*\
  !*** multi @babel/polyfill/noConflict ./assets/js/Login/login.js ***!
  \*******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! @babel/polyfill/noConflict */\"./node_modules/@babel/polyfill/noConflict.js\");\nmodule.exports = __webpack_require__(/*! /Users/lcy/Desktop/Git_Repository/NAC_using_hyperledgerFabric/frontend/assets/js/Login/login.js */\"./assets/js/Login/login.js\");\n\n\n//# sourceURL=webpack:///multi_@babel/polyfill/noConflict_./assets/js/Login/login.js?");
